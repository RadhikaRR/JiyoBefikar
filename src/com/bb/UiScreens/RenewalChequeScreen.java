...
public class RenewalChequeScreen extends MainScreenClass {

	private ListField _lf;
	private String[] listItemArray = Constants.policyArray;
	private String selectedFundValue;

	public RenewalChequeScreen(String screenTitle) {
		...
		_lf = new ListField() {
			protected boolean navigationClick(int status, int time) {
				...
				Dialog.alert("The Request For The Selected Policy Will Be Forwarded, please note Reference No. "
								+ selectedFundValue);
				return true;
			}
		};
