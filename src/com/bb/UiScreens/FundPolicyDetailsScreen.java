...
public class FundPolicyDetailsScreen extends MainScreenClass {
	...
	public FundPolicyDetailsScreen(String screenTitle) {
		super(screenTitle);

		HorizontalFieldManager labelHorizontalFieldManager = new HorizontalFieldManager();
		BorderLabelFieldImpl label = new BorderLabelFieldImpl("Fund Value", USE_ALL_WIDTH | Field.FOCUSABLE
				| DrawStyle.HCENTER);
	...
	public void GridTable() {
		...
		borderLabelFieldImpl = new BorderLabelFieldImpl("Fund Value", Field.FOCUSABLE | USE_ALL_WIDTH
				| DrawStyle.HCENTER);
		borderLabelFieldImpl.setFont(Constants.font);
		borderLabelFieldImpl.setFontColor(Color.WHITE);
		borderLabelFieldImpl.setBgColor(Constants.hbgColor);
