...
public class PersistProvider {
	...
	private static long databaseKey = 0x3a01388ce19acb59L;
	...
	public void saveObject(String key, String value) {
		...
		try {
			...
			synchronized (persistentObject) {
				PersistImpl contents = (PersistImpl) persistentObject.getContents();
				if (contents == null) {
	...
	public String getObject(String key) {
		...
		try {
			persistentObject = PersistentStore.getPersistentObject(databaseKey);
			synchronized (persistentObject) {
				PersistImpl value = (PersistImpl) persistentObject.getContents();
				if (value == null) {
